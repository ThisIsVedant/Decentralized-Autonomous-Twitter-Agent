## About ZerePy
This project is a modified version of [ZerePy](https://github.com/blorm-network/ZerePy) by Ayoub Eddakhly.
Changes were made to fit specific requirements. The project remains under the MIT License.
